...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	renderNumberCellHtml: function(date) {
		...
		classes.unshift('fc-day-number');
			// console.log(typeof(classes));  //object
			//console.log(typeof(classes.join(' ')));  //string
			// console.log(classes.join(' ').length)  //返回上一个字符串的长度，48时是fc-today
			// for (var i = 0; i < classes.length; i++) {
			// 		var patt1=new RegExp("fc-today");
			// 		var result = patt1.test(classes.join(' '));
			// 		// console.log(result);
				if (classes.join(' ').length != 48) {
